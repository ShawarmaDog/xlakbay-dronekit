...
while counter < 5: 
	#Move true north
        ...
        print("Moving TRUE NORTH1")
        time.sleep(3)
        send_global_ned_velocity(0.5,0,0)
        print("Moving TRUE NORTH2")
        time.sleep(3)
        
        #Move true east
        send_global_ned_velocity(0,0.5,0)
        print("MOVING TRUE EAST1")
        time.sleep(3)
        send_global_ned_velocity(0,0.5,0)
        print("MOVING TRUE EAST2")
        time.sleep(3)
        
        #Move true south
        send_global_ned_velocity(-0.5,0,0)
        print("MOVING TRUE SOUTH1")
        time.sleep(3)
        send_global_ned_velocity(-0.5,0,0)
        print("MOVING TRUE SOUTH2")
        time.sleep(3)
        
        #Move true west
        send_global_ned_velocity(0,-0.5,0)
        print("MOVING TRUE WEST1")
        time.sleep(3)
        send_global_ned_velocity(0,-0.5,0)
        print("MOVING TRUE WEST2")
        time.sleep(3)
